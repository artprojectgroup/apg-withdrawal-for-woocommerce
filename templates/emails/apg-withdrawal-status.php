...
<p><?php esc_html_e( 'We are writing to inform you of an update to your withdrawal request.', 'apg-withdrawal-for-woocommerce' ); ?></p>
...
<table cellspacing="0" cellpadding="6" style="width:100%;border-collapse:collapse;" border="1">
	<tbody>
		...
		<tr>
			<th scope="row" style="text-align:left;border:1px solid #eee;padding:12px;"><?php esc_html_e( 'New status', 'apg-withdrawal-for-woocommerce' ); ?></th>
